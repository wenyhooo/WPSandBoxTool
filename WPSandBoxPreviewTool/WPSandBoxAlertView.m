...
@interface WPSandBoxAlertView ()<UITableViewDataSource,UITableViewDelegate,UIGestureRecognizerDelegate>
...
@implementation WPSandBoxAlertView

+ (WPSandBoxAlertView *)createAlertViewWith:(NSArray * )dataSource  AndCancleTitle:(NSString *)cancleTitle andClick:(void(^)(int row))clickBlock{
    WPSandBoxAlertView * alertView = [[WPSandBoxAlertView alloc]initWithFrame:[UIScreen mainScreen].bounds];
