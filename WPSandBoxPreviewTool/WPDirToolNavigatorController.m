//
//  WPDirToolNavigatorController.m
//  FileDirectoryTool
//
...
#import "WPSandBoxSuspensionButton.h"
@interface WPDirToolNavigatorController ()<UIGestureRecognizerDelegate>

@end


@implementation WPDirToolNavigatorController


+ (instancetype)create{
    WPHomeDirViewController * homeDir = [[WPHomeDirViewController alloc] init];
    homeDir.isHomeDir = YES;
    return [[WPDirToolNavigatorController alloc] initWithRootViewController:homeDir];
}
...
- (void)viewDidLoad {
    ...
    WPSandBoxSuspensionButton * button = [[WPSandBoxSuspensionButton alloc] initWithFrame:CGRectMake(-5, [UIScreen mainScreen].bounds.size.height/2 , 50, 50) color:[UIColor colorWithRed:135/255.0 green:216/255.0 blue:80/255.0 alpha:1]];
